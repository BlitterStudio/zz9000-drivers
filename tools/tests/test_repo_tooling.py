...
class RepoToolingTests(unittest.TestCase):
    ...
    def test_zzdiag_compares_pre_ddr_probe_with_capture_memory(self):
        ...
        self.assertIn("ZZ_REG_VCAP_TAIL_PROBE_DATA_BASE", header)
        self.assertIn("ZZ_REG_VCAP_TAIL_PROBE_META", header)
        ...
        self.assertIn("VideoCapTailTarget", text)
        self.assertIn("VideoCapTailTransitions", text)
        self.assertIn("VideoCapTail[", text)
        self.assertIn('#define ZZDIAG_VERSION "1.8"', text)
