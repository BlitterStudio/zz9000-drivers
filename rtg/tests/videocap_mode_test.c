...
int main(void)
{
    ...
    CHECK(zz_vcap_mode_sanitize(99, ZZ_FW_CAP_VIDEOCAP_CENTERED_1080P) ==
        ZZ_VMODE_800x600);
    CHECK(zz_vcap_native_pan_offset(ZZ_VMODE_800x600) == 0x00e00000UL);
    CHECK(zz_vcap_native_pan_offset(ZZ_VMODE_720x576) == 0x00e00000UL);
    CHECK(zz_vcap_native_pan_offset(ZZ_VMODE_CENTERED_1080P_60) ==
        0x00dff2f8UL);
    ...
    CHECK(zz_vcap_native_pan_offset(ZZ_VMODE_CENTERED_1080P_MATCH) ==
        0x00dff2f8UL);
